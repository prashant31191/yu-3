...
import com.youtube.ActWebviewTag;
...
public class YTrailerFragment extends android.support.v4.app.Fragment {
    int color;
    ...
    public YTrailerFragment() {
    }

    @SuppressLint("ValidFragment")
    public YTrailerFragment(int color) {
        this.color = color;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        //Log.i("--setUserVisibleHint--","==============Start===========");
                    ...
                    if (arrayListItems != null && arrayListItems.size() > 2) {
                        for (int i = 0; i < arrayListItems.size(); i++) {
                            ...
                            try {
                                ...
                                Log.e("==Database==","--Trailer-Already inserted-");
                                ex.printStackTrace();
                            } catch (Error e) {
                                e.printStackTrace();
                                Log.e("==Database==","--Trailer-Already inserted-");
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            if (yTrailerModel_Items != null && yTrailerModel_Items.getId() != null && yTrailerModel_Items.getId().getVideoId() != null) {
               ...
               Picasso.with(mContext)
                        .load(strImgUrl)
                        .resize(100, 100)
                        .placeholder(R.drawable.p_landscap)
                        .error(R.drawable.ic_action_mic)
                       .transform(blurTransformation)
                       .into(holder.ivImage, new com.squareup.picasso.Callback() {
                           @Override
                           public void onSuccess() {
                               Picasso.with(mContext)
                                       .load(strImgUrl) // image url goes here
                                       // .resize(imageViewWidth, imageViewHeight)
                                       .resize(500, 400)
                                       .placeholder(holder.ivImage.getDrawable())
                                       .into(holder.ivImage);
                           }
             ...
             /*   Picasso.with(mContext)
                        .load(strImgUrl) // thumbnail url goes here
                        .placeholder(R.drawable.p_landscap)
                        .resize(360, 200)
                        .transform(blurTransformation)
                        .into(holder.ivImage, new com.squareup.picasso.Callback() {
...
*/
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(View view) {
                ...
                ivImage = (PEWImageView) view.findViewById(R.id.ivImage);
    ...
    Transformation blurTransformation = new Transformation() {
        ...
        public Bitmap transform(Bitmap source) {
            Bitmap blurred = Blur.fastblur(mActivity, source, 10);
            source.recycle();
            return blurred;
        }
