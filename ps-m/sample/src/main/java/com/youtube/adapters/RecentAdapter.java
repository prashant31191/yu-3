...
public class RecentAdapter  extends RecyclerView.Adapter<RecentAdapter.VersionViewHolder> {
    ...
    public RecentAdapter(List<String> versionModels) {
        isHomeList = false;
