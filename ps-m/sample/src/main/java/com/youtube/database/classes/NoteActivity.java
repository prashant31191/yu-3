...
public class NoteActivity extends ListActivity {
    ...
    private NoteDao getNoteDao() {
        // 通过 AppDB 类提供的 getDaoSession() 获取具体 Dao
        return ((AppDB) this.getApplicationContext()).getDaoSession().getNoteDao();
    }

    private SQLiteDatabase getDb() {
        // 通过 AppDB 类提供的 getDb() 获取具体 db
        return ((AppDB) this.getApplicationContext()).getDb();
    }
    ...
    private void search() {
        ...
        if (noteText == null || noteText.equals("")) {
            ...
            ToastUtils.show(getApplicationContext(), "There have " + notes.get(0) + " records");
        }
