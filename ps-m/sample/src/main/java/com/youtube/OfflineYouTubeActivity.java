...
import com.youtube.fragments.YTrailerOfflineFragment;
import com.youtube.utils.CustomProgressDialog;

import java.util.ArrayList;
import java.util.List;

public class OfflineYouTubeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        customProgressDialog = new CustomProgressDialog(OfflineYouTubeActivity.this);
...
//        mBottomBar.noNavBarGoodness();
    ...
    private void setupViewPager(ViewPager viewPager)
    {
        ...
        YTrailerOfflineFragment yTrailerOfflineFragment =   new YTrailerOfflineFragment(getResources().getColor(R.color.clrTab3));
        ...
        adapter.addFrag(yTrailerOfflineFragment, getResources().getString(R.string.tab_3));
